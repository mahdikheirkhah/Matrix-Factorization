...
from utils.matrix_creation import filter_sparse_data, create_user_item_matrix, normalize_matrix
...
def run_preprocessing():
    try:
        ...
        clean_ratings = filter_sparse_data(ratings, min_ratings_per_user=20, min_ratings_per_movie=50)
        
        # 3. Split data (Audit Req: random_state=42)
        logger.info("✂️ Splitting data into Train/Test sets...")
        train_df, test_df = train_test_split(clean_ratings, test_size=0.2, random_state=42)
